### Full Stack Engineer | Ruby on Rails & JavaScript

4+ years building SaaS platforms and community tools with Ruby on Rails, EmberJS, and React. Lead maintainer of open-source Discourse plugins with 10,000+ combined installations. Shipped 15+ features for enterprise clients, optimized systems from 30+ API calls down to 1, and built email engagement pipelines with 90% open rates.
...
|--------|-------|-------------|
| [Ratings](https://github.com/paviliondev/discourse-ratings) | 39 | Topic rating system for community feedback |
| [Multilingual](https://github.com/paviliondev/discourse-multilingual) | 29 | Multi-language content support for global communities |
| [Tickets](https://github.com/paviliondev/discourse-tickets) | 22 | Full support ticket system |
| [Category Lockdown](https://github.com/paviliondev/discourse-category-lockdown) | 6 | Category-level access control |
...
![EmberJS](https://img.shields.io/badge/-Ember.js-E04E39?style=flat&logo=emberdotjs&logoColor=white)
...
[LinkedIn](https://www.linkedin.com/in/jumagura) · [Discourse](https://meta.discourse.org/u/jumagura) · jumagura@gmail.com
